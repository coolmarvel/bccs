...
const {
  MNEMONIC, // 복구키
  PRIVATE_KEY, // 비밀키
  KLAYTN_MAINNET_RPC_URL, // 클레이튼 메인넷
  KLAYTN_TESTNET_RPC_URL, // 클레이튼 테스트넷
  POLYGON_MAINNET_RPC_URL, // 폴리곤 메인넷
  POLYGON_TESTNET_RPC_URL_V1, // 폴리곤 테스트넷
  POLYGON_TESTNET_RPC_URL_V2, // 폴리곤 테스트넷
  ETHEREUM_MAINNET_RPC_URL, // 이더리움 메인넷
  ETHEREUM_GOERLI_RPC_URL, // 이더리움 테스트넷
  ETHEREUM_SEPOLIA_RPC_URL, // 이더리움 테스트넷
} = process.env;
...
module.exports = {
  ...
  contracts_build_directory: "./build/sepolia/contracts",
